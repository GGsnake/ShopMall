...
//    @LoginRequired
//    @PostMapping("/myOder")
//    public Response queryAllOder(HttpServletRequest request, PageParam pageParam, Integer devId, Integer status) {
...
//        }
//        return ResponseUtil.success(allOder);
//    }
//
//    /**
//     * 我的收益报表接口
...
//    @LoginRequired
//    @PostMapping("/InCome")
//    public Response queryInCome(HttpServletRequest request) {
//        String uid = (String) request.getAttribute(Constants.CURRENT_USER_ID);
//        if (uid == null) {
//            return ResponseUtil.fail(ResponseCode.COMMON_PARAMS_MISSING);
//        }
